         ...
         <section class="section dashboard">
            ...
            <div class="row">
                <div class="col-md-12" style="text-align: right; padding: 20px;">
                       ...
                       <a type="button" class="btn btn-primary" href="<?= base_url('category/add') ?>">Add Category</a>
                </div>
                                    ...
                                    if($categories){
                                        foreach($categories as $cat){
                                            ...
                                            <tr>
                                             ...
                                             <img src="../images/category/<?=$cat->image?>" width="50"/>
                                             <?php }?></td>
                                                <td><?=$cat->name?></td>
                                                
                                                <td>
                                                   <a href="<?= base_url('category/edit/' . $cat->id) ?>" > <i class="fa fa-edit" style="font-size:22px; cursor: pointer;"></i> </a>
